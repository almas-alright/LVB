...
public class DataHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_VALUE = "item_val";
    ...
    void addItem(Item item) {
        ...
        values.put(KEY_NAME, item.get_item_name()); // Item Name
        values.put(KEY_VALUE, item.get_item_val()); // Item Phone
    ...
    public List<Item> getAllItems() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                item.set_item_name(cursor.getString(1));
                item.set_item_val(cursor.getString(2));
                // Adding item to list
                itemList.add(item);
    ...
    public int updateItem(Item item) {
        ...
        ContentValues values = new ContentValues();
        values.put(KEY_NAME, item.get_item_name());
        values.put(KEY_VALUE, item.get_item_val());
